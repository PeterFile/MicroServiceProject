...
import com.hmall.cart.repository.dto.CartFormDTO;
import com.hmall.cart.repository.po.Cart;
import com.hmall.cart.repository.vo.CartVO;
...
//    private final DiscoveryClient discoveryClient;
    ...
    public List<CartVO> queryMyCarts() {
        // 1.查询我的购物车列表
        List<Cart> carts = lambdaQuery().eq(Cart::getUserId, UserContext.getUser() /* TODO UserContext.getUser() */).list();
